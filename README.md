...
**Data:** 200 universities v0.23 (200/200 Scorecard-real 100%, 200/200 endowment-real 100%, 198/200 research real NSF HERD, 200/200 lat/long real, 200/200 distinct IDs, 36 conferences, 12 LACs, score formula declamped 55-97, correlations carry two-tailed p-values, sort state deep-links via ?sort=, dimension card is a true radial radar with min–max 0–100 normalization)
